#ADVANCEMENT CHECK
execute as @a run function mcpeachpies:multiplayer_sleeping/advancement_clean
...
execute unless score mpp_sleep_setup mpp_datapacks matches 1.. run function mcpeachpies:multiplayer_sleeping/setup