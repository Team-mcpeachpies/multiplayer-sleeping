...
#Total Player Count
execute store result score value_required mpp_sleep_count if entity @a[gamemode=!spectator,tag=!mpp_afk,predicate=mcpeachpies:multiplayer_sleeping/in_overworld]
